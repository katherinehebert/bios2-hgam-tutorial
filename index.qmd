...
![[Noam Ross - GAMs in R course, chapter 1.](https://noamross.github.io/gams-in-r-course/chapter1)](basis_functions.jpeg){fig-align="center"}
...
![](taxo_hier.jpg){fig-align="center"}
...
-   Thin Plate Regression Splines ("tp" in mgcv): General purpose spline basis. If you do not have phenology in your data and your smooth only has one covariate = probably this type of basis functions. To learn more –\> [Wood (2003)](https://rss.onlinelibrary.wiley.com/doi/abs/10.1111/1467-9868.00374)
...
-   Based on [Pedersen et al. (2019)](https://peerj.com/articles/6876/)

![](pedersenetal.jpg){fig-align="center" width="390"}
...
![From Hierarchical generalized adidtive models in ecology: an introduction with mgcv, by Pedersen et al. (2019)](fig4_pedersen_etal.jpg){fig-align="center" width="476"}
...
# Part 2 - Digging deeper with Dynamic (and Hierarchical!) Generalized Additive Models
